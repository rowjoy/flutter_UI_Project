...
import 'package:seepups/controllers/sign_up/sign_otp_submisson.dart';
...
class SignUpOTPpage extends StatefulWidget {
  static const String path = "SifnUpOTPpage";
...
class _OTPpageState extends State<SignUpOTPpage> {
  final SIGNOTPSUB otpsub = Get.put(SIGNOTPSUB());
